...
function showView(viewName) {
    document.querySelectorAll('.view-schools, .view-school-detail, .view-groups, .view-group-detail, .view-student-detail, .view-trash').forEach(view => {
...
function setupEventListeners() {
    ...
    if (editSchoolBtn) editSchoolBtn.addEventListener('click', () => openSchoolModal(currentSchoolId));

    const deleteSchoolBtn = document.getElementById('deleteSchoolBtn');
    if (deleteSchoolBtn) deleteSchoolBtn.addEventListener('click', () => deleteSchool(currentSchoolId));

    const cancelSchoolBtn = document.getElementById('cancelSchoolBtn');
    if (cancelSchoolBtn) cancelSchoolBtn.addEventListener('click', closeSchoolModal);

    const saveSchoolBtn = document.getElementById('saveSchoolBtn');
    if (saveSchoolBtn) saveSchoolBtn.addEventListener('click', saveSchool);
    ...
    if (schoolForm) schoolForm.addEventListener('submit', (e) => { e.preventDefault(); saveSchool(); });

    // Navigation Back Buttons
    const backToSchools = document.getElementById('backToSchools');
    if (backToSchools) {
        backToSchools.addEventListener('click', (e) => {
            e.preventDefault();
            showView('viewSchools');
            renderSchools();
        });
    ...
    if (backToSchool) {
        backToSchool.addEventListener('click', (e) => {
            e.preventDefault();
            if (currentSchoolId) {
    ...
    const backToGroupsFromTrash = document.getElementById('backToGroupsFromTrash');
    if (backToGroupsFromTrash) {
        backToGroupsFromTrash.addEventListener('click', () => {
            showView('viewSchools');
            renderSchools();
        });
    }
    ...
    if (backToGroup) {
        backToGroup.addEventListener('click', (e) => {
            e.preventDefault();
            if (currentGroupId) {
    ...
    if (editGroupBtn) editGroupBtn.addEventListener('click', () => openGroupModal(currentGroupId));
    ...
    const pasteTextarea = document.getElementById('importRawText') || document.getElementById('importPasteTextarea');
    if (pasteTextarea) {
    ...
    const dropzone = document.getElementById('importDropZone') || document.getElementById('importDropzone');
    const csvFileInput = document.getElementById('importFileInput') || document.getElementById('importCsvFileInput');
    ...
    const cancelImportBtn = document.getElementById('cancelImportStudentsBtn') || document.getElementById('cancelImportBtn');
    if (cancelImportBtn) {
        cancelImportBtn.addEventListener('click', closeImportStudentsModal);
    }

    const closeImportBtn = document.getElementById('closeImportStudentsModalBtn');
    if (closeImportBtn) {
        closeImportBtn.addEventListener('click', closeImportStudentsModal);
    }

    const confirmImportBtn = document.getElementById('confirmImportStudentsBtn') || document.getElementById('confirmImportBtn');
    if (confirmImportBtn) {
